...
na=Label(text="The commenting page of the System",font=('Helvetica',36,'bold'))
na.pack(pady=20)
wrapper1 = LabelFrame(root, text="Comments",fg="red")
wrapper2 = LabelFrame(root, text="Comments",fg="red")


wrapper1.pack(fill="both", expand="yes", padx=40, pady=70)
wrapper2.pack(fill="both", expand="yes", padx=40, pady=10,ipady=20)
